...
class Elem:
    ...
    def __init__(self, tag='div', attr={}, content=None, tag_type='double'):
        ...
        elif not content is None and not isinstance(content, Text):
...
def main():
    page = Elem(tag='html',
                ...
                content=Text('"Hello ground!"'))),Elem(tag='body',
                content=[Elem(tag='h1', 
                content=Text('"Oh no, not again!"')),Elem(tag='img', 
                tag_type='simple', attr={'src':'http://i.imgur.com/pfp3T.jpg'})])])
    print(page)
